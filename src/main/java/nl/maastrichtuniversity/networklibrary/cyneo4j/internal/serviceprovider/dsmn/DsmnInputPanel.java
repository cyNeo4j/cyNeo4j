...
public class DsmnInputPanel extends JPanel implements ActionListener {
	...
	public DsmnInputPanel(JDialog dialog, Plugin plugin) {
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
				.addGroup(layout.createParallelGroup().addComponent(labelName).addComponent(labelTextArea))
				.addGroup(layout.createParallelGroup().addComponent(textField).addComponent(jScrollPane1))
				.addGroup(layout.createSequentialGroup().addComponent(okButton).addComponent(cancelButton)));
		layout.setVerticalGroup(layout.createSequentialGroup()
				.addGroup(layout.createSequentialGroup().addComponent(labelName).addComponent(textField)
						.addComponent(labelTextArea).addComponent(jScrollPane1))
