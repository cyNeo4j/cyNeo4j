...
public interface ExtensionExecutor {
	...
	/**
	 * Use this method to obtain all necessary parameters for the execution of the
	 * extension form the user and/or the environment
	 * 
	...
	/**
	 * This method will be called after each extension call is executed by the
	 * server.
	 * 
	...
	/**
	 * Generate here a list of calls that should be executed. Each of the calls is
	 * going to be executed sequentially and the call and result will be handed
	 * backed to the ExtensionExecutor
	 * 
